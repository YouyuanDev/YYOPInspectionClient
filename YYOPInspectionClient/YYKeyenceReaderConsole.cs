...
{
    public partial class YYKeyenceReaderConsole : Form
    {
        ...
        public YYKeyenceReaderConsole(ThreadingProcessForm threadingProcessForm=null)
        {
            InitializeComponent();
            //
